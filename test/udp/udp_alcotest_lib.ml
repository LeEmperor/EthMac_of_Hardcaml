(*
  ...
  Series of testables and library functions for alcotest integration for UDP MAC stack in hardcaml.
  ...
  Design Notes:
    ...
    for an expect-test based item
      should we compare the output of the frame against a golden?
      or have a sw model compoes each frame?
      probably a sw-model
*)
