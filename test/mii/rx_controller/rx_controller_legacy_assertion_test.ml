...
(* Module: "rx_controller_legacy_assertion_test.ml" *)

(* Legacy Assertion Test: Rx_controller

   Deprecated standalone simulation and manual assertion harness, formerly
   [test/mii/rx_controller_tb.ml]. The unit, Quickcheck, and expect suites in this
